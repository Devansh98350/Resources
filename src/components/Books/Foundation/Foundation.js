...
const FoundationBooks = () => {
  ...
  const questionsData = [
    {
      id: "",
      title: "Foundation Science & Mathematics Series",
      author: "Pearson",
      bgColor: "bg-[#12bd84]",
      image: img1,
    },
    ...
    {
      id: "",
      title: "Olympiad Skill Development Books",
      author: "MTG",
      bgColor: "bg-[#12bd84]",
      image: img2,
    },
  ...
  return (
    <Layout title="Foundation Books - IIT Academy" keyword="" description="">
      <Breadcrumbs />
      <div className="container mx-auto px-4">
        <div className="mb-10">
          <h1 className="text-[2rem] font-bold text-blue mb-4">
            Foundation Level Textbooks
          </h1>
        </div>
              ...
              <Link to={`#`}>
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-white text-sm">{item.author}</span>
