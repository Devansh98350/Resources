...
const CbsePYQ2021 = () => {
  ...
  return (
    <Layout title="CBSE 2021 PYQ - IIT Academy" keyword="" description="">
      <Breadcrumbs />
      <div className="container mx-auto px-4">
        <div className="mb-10">
          <h1 className="text-[2rem] font-bold text-blue ">
            CBSE 2021 Question Paper
          </h1>
        </div>
