...
const NeetPYQ2017 = () => {
  ...
  return (
    <Layout title="NEET 2017 PYQ - IIT Academy" keyword="" description="">
      <Breadcrumbs />
          ...
          <div className="listdata">
            <ul>
              ...
              <li className="text-gray-600">
                ...
                correct and should be a bonus and one question from
                photoelectric effect has 2 same options.
              </li>
            </ul>
          </div>
          <h4 className="mb-0 mt-0">
