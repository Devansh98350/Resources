...
const JeeMainPYQ2022 = () => {
  ...
  return (
    <Layout title="JEE Mains 2022 PYQ - IIT Academy" keyword="" description="">
      <Breadcrumbs />
      <div className="container mx-auto px-4">
        <div className="mb-10">
          <h1 className="text-[2rem] font-bold text-blue mb-4">
            JEE Mains 2022 Question Paper
          </h1>
        </div>
