  ...
  return (
    <Layout title="Resources - IIT Academy">
      ...
      <div className="container mx-auto px-4">
        <Scroller title="About Exams" categoryId="exams" items={examData} />
        ...
        <Scroller title="Syllabus" categoryId="syllabus" items={syllabusData} />

        <Scroller title="Books" categoryId="books" items={booksData} />
      </div>
      <Query />
    </Layout>
  );
