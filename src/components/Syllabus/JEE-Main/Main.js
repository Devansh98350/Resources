    ...
    <Layout title="JEE-Mains-Syllabus-IIT-Academy">
      ...
      >
        ...
        <p>
          ...
          force and its applications: vehicle on a level circular road, vehicle
          on a banked road.
        </p>
        <p>
        ...
        <p>
          ...
          rigid bodies, rigid body rotation and equations of rotational motion,
        ...
        <p>
          ...
          velocity, Motion of a satellite, orbital velocity, time period, and
          energy of satellite.
        </p>
        <p>
          ...
          fluid column; Pascal's law and its applications. Effect of gravity on
          fluid pressure. Viscosity. Stokes' law. terminal velocity, streamline,
          and turbulent flow.critical velocity. Bernoulli's principle and its
          applications. Surface energy and surface tension, angle of contact,
          excess of pressure across a curved surface, application of surface
          tension - drops, bubbles, and capillary rise. Heat, temperature,
          thermal expansion; specific heat capacity, calorimetry; change of
          state, latent heat. Heat transferconduction, convection, and
          radiation.
        </p>
        <p>
        ...
        <p>
          ...
          principle and continuous charge distribution. Electric field: Electric
          field due to a point charge, Electric field lines. Electric dipole,
          Electric field due to a dipole. Torque on a dipole in a uniform
          electric field. Electric flux. Gauss's law and its applications to
          find field due to infinitely long uniformly charged straight wire
          ...
          charge, electric dipole and system of charges; potential difference,
          ...
          and parallel, and capacitance of a parallel plate capacitor with and
        ...
        <p>
          ...
          cell, a combination of cells in series and parallel. Kirchhoff’s laws
          and their applications. Wheatstone bridge. Metre Bridge.
        </p>
        <p>
          <strong>UNIT 13: MAGNETIC EFFECTS OF CURRENT AND MAGNETISM:</strong>
          <br />
          Biot - Savart law and its application to the current carrying circular
          ...
          uniform magnetic and electric fields. Force on a current-carrying
          conductor in a uniform magnetic field. The force between two parallel
          currents carrying conductors-definition of ampere. Torque experienced
          by a current loop in a uniform magnetic field: Moving coil
          galvanometer, its sensitivity, and conversion to ammeter and
          ...
          Magnetic field due to a magnetic dipole (bar magnet) along its axis
          and perpendicular to its axis. Torque on a magnetic dipole in a
          uniform magnetic field. Para-, dia- and ferromagnetic substances with
        ...
        <p>
          ...
          Transverse nature of electromagnetic waves, Electromagnetic spectrum
        ...
        <p>
          ...
          light at plane and spherical surfaces, thin lens formula, and lens
          maker formula. Total internal reflection and its applications.
          Magnification. Power of a Lens. Combination of thin lenses in contact.
          Refraction of light through a prism. Microscope and Astronomical
          ...
          sustained interference of light. Diffraction due to a single slit,
          width of central maximum. Polarization, plane-polarized light:
          Brewster's law, uses of planepolarized light and Polaroid.
        </p>
        <p>
        ...
        <p>
          ...
          nucleus, atomic masses, Mass-energy relation, mass defect; binding
        ...
        <p>
          ...
          the photodiode, solar cell, and Zener diode; Zener diode as a voltage
        ...
        <p>
          ...
          gauge-its use to determine the thickness/ diameter of thin sheet/wire.
          3. Simple Pendulum-dissipation of energy by plotting a graph between
          the square of amplitude and time. 4. Metre Scale - the mass of a given
          object by the principle of moments. 5. Young's modulus of elasticity
          of the material of a metallic wire. 6. Surf ace tension of water by
          capillary rise and effect of detergents, 7. Co-efficient of Viscosity
          of a given viscous liquid by measuring the terminal velocity of a
          given spherical body, 8. Speed of sound in air at room temperature
          using a resonance tube, 9. Specific heat capacity of a given (i) solid
          and (ii) liquid by method of mixtures. 10. The resistivity of the
          material of a given wire using a metre bridge. 11. The resistance of a
          given wire using Ohm's law. 12. Resistance and figure of merit of a
          galvanometer by half deflection method. 13. The focal length of; (i)
          Convex mirror (ii) Concave mirror, and (ii) Convex lens, using the
          parallax method. 14. The plot of the angle of deviation vs angle of
          incidence for a triangular prism. 15. The refractive index of a glass
          slab using a travelling microscope. 16. Characteristic curves of a p-n
          junction diode in forward and reverse bias. 17. Characteristic curves
          of a Zener diode and finding reverse breakdown voltage. 18.
        ...
        <p>
          ...
          molecule, element, and compound:: Laws of chemical combination; Atomic
        ...
        <p>
          ...
          derivation of the relations for the energy of the electron and radii
          of the different orbits, limitations of Bohr's model; Dual nature of
          ...
          mechanical model of the atom, and its important features. Concept of
          atomic orbitals as one-electron wave functions: Variation of  and 2
          with r for 1s and 2s orbitals; various quantum numbers (principal,
        ...
        <p>
          ...
          affecting the formation of ionic bonds; calculation of lattice
          enthalpy. Covalent Bonding: Concept of electronegativity. Fajan’s
        ...
        <p>
          ...
          constant heat summation; Enthalpies of bond 10 dissociation,
          combustion, formation, atomization, sublimation, phase transition,
          hydration, ionization, and solution. The second law of thermodynamics
          - Spontaneity of processes; △S of the universe and G of the system as
        ...
        <p>
          ...
          and nonideal solutions; Colligative properties of dilute solutions - a
        ...
        <p>
          ...
          gas and solid-gas equilibria, Henry's law. General characteristics of
          equilibrium involving physical processes. Equilibrium involving
          chemical processes: Law of chemical equilibrium, equilibrium constants
          (Kp and Kc) and their significance, the significance of G and G in
          chemical equilibrium, factors affecting equilibrium concentration,
          pressure, temperature, the effect of catalyst; Le Chatelier’s
          principle. Ionic equilibrium: Weak and strong electrolytes, ionization
          ...
          their solutions, the solubility of sparingly soluble salts and
          solubility products, and buffer solutions.
        </p>
        <p>
          <strong>UNIT 7: REDOX REACTIONS AND ELECTROCHEMISTRY:</strong>
          <br />
          Electronic concepts of oxidation and reduction, redox reactions,
          oxidation number, rules for assigning oxidation number, and balancing
          of redox reactions. Electrolytic and metallic conduction, conductance
          in electrolytic solutions, molar conductivities and their variation
        ...
        <p>
          ...
          oxidation states, and lanthanoid contraction. Actinoids - Electronic
        ...
        <p>
          ...
          Nomenclature (Trivial and IUPAC) Covalent bond fission - Homolytic and
          ...
          electromeric effect, resonance, and hyperconjugation. Common types of
          organic reactions - Substitution, addition, elimination, and
          rearrangement.
        </p>
        ...
        <p>
          ...
          Sawhorse and Newman projections (of ethane): Mechanism of halogenation
          of alkanes. Alkenes - Geometrical isomerism: Mechanism of
        ...
        <p>
          ...
          ALCOHOLS, PHENOLS, AND ETHERS 13 Alcohols: Identification of primary,
          secondary, and tertiary alcohols: mechanism of dehydration. Phenols:
          Acidic nature, electrophilic substitution reactions: halogenation.
          nitration and sulphonation. Reimer - Tiemann reaction. Ethers:
          Structure. Aldehyde and Ketones: Nature of carbonyl group;
          ...
          Haloform reaction, Chemical tests to distinguish between aldehydes and
          Ketones. Carboxylic Acids Acidic strength and factors affecting it.
        </p>
        <p>
        ...
        <p>
          ...
          (sucrose, lactose, and maltose). PROTEINS - Elementary Idea of α-amino
          acids, peptide bond, polypeptides. Proteins: primary, secondary,
          tertiary, and quaternary structure (qualitative idea only),
          denaturation of proteins, enzymes. VITAMINS – Classification and
          functions. NUCLEIC ACIDS – Chemical constitution of DNA and RNA.
        ...
        <p>
          ...
          and amino groups in organic compounds. <br />• The chemistry involved
          in the preparation of the following: Inorganic compounds; Mohr’s salt,
          potash alum. 14 Organic compounds: Acetanilide, p-nitro acetanilide,
          aniline yellow, iodoform. <br />• The chemistry involved in the
          titrimetric exercises – Acids, bases, and the use of indicators,
          oxalic-acid vs KMnO4, Mohr’s salt vs KMnO4 <br />• Chemical principles
          involved in the qualitative salt analysis: Cations – Pb2+, Cu2+, Al3+,
          Fe3+, Zn2+, Ni2+, Ca2+, Ba2+, Mg2+ , NH4 + Anions- CO3 2−, S 2- ,SO4
