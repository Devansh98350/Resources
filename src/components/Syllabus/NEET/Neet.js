    ...
    <Layout title="NEET-Syllabus-IIT-Academy">
      ...
      >
        ...
        <p>
          ...
          <br />• Animal tissues; Morphology, anatomy and functions of different
        ...
        <p>
          ...
          Cytoskeleton, cilia, flagella, centrioles (ultra structure and
          ...
          nomenclature of anzymes. <br />• B Cell division: Cell cycle, mitosis,
        ...
        <p>
          ...
          photosynthesis; Cyclic and non cyclic and ll photophosphorylation;
          chemiosmotic hypothesis; photorespiration C3 and C4 pathways; Factors
          affecting photosynthesis. <br />• Respiration: Exchange gases;
          cellular respiration-glycolysis. fermentation (anaerobic), TCA cycle
          and electron transport system (aerobic); Energy relations- Number of
          ...
          Differentiation, dedifferentiation and redifferentiation; Sequence of
          developmental process in a plant cell; Growth regulators-auxin,
          gibberellin, cytokinin, ethylene, ABA.
        </p>
        <p>
          <strong>UNIT 5: Human Physiology:</strong> <br />• Breathing and
          Respiration: Respiratory organs in animals (recall only); Respiratory
          system in humans; Mechanism of breathing and its regulation in
          humans-Exchange of gases, transport of gases and regulation of
          ...
          cardiac cycle, cardiac output. ECG. Double circulation; Regulation of
          cardiac activity; Disorders of circuratory system-Hypertension,
          ...
          and artificial kidney. <br />• Locomotion and Movement: Types of
          movement- ciliary, fiagellar, muscular; Skeletal muscle- contractile
          proteins and muscle contraction; Skeletal system and its functions (To
          be dealt with the relevant practical of practical syllabus); Joints;
          Disorders of muscular and skeletal system-Myasthenia gravis, Tetany,
          Muscular dystrophy, Arthritis, Osteoporosis, Gout. <br />• Neural
          control and coordination: Neuron and nerves; Nervous system in humans
          central nervous system, peripheral nervous system and visceral nervous
          system; Generation and conduction of nerve impulse; <br />• Chemical
          coordination and regulation: Endocrine glands and hormones; Human
        ...
        <p>
          ...
          Double fertilization; Post fertilization events- Development of
          endosperm and embryo, Development of seed and formation of fruit;
          Special modesapomixis, parthenocarpy, polyembryony; Significance of
          seed and fruit formation. <br />• Human Reproduction: Male and female
        ...
        <p>
          <strong>UNIT 7: Genetics and Evolution:</strong> <br />• Heredity and
          ...
          Sex linked inheritance-Haemophilia, colour blindness; Mendelian
          disorders in humans-Thalassemia; chromosomal disorders in humans;
          Down's syndrome, Tumer's and Klinefelter's syndromes. <br />•
          ...
          Gene expression and regulation- Lac Operon; Genome and human genome
          project; DNA finger printing, protein biosynthesis. <br />• Evolution:
          ...
          Evolution; Mechanism of evolution Variation (Mutation and
        ...
        <p>
          <strong>UNIT 8: Biology and Human Welfare:</strong> <br />• Health and
          Disease; Pathogens; parasites causing human diseases (Malaria,
        ...
        <p>
          ...
          (Recombinant DNA technology). <br />• Application of Biotechnology in
          health and agriculture: Human insulin and vaccine production, gene
          therapy; Genetically modified organisms-Bt crops: Transgenic Animals
          Biosafety issues-Biopiracy and patents.
        </p>
        <p>
          <strong>UNIT 10: Ecology and Environment :</strong> <br />• organisms
          and environrnent; Population interactions-mutualism, competition,
          predation, parasitism, Population attributes-growth. birth rate and
          death rate, age distribution. <br />• Ecosystem: Patterns, components;
          productivity aud decomposition: Energy flow: Pyramids of number,
          biomass. energy. <br />• Biodiversity and its conservation: concept of
          Biodiversity; patterns of Biodiversity: Importance of Biodiversity;
          Loss of Biodiversity, Biodiversity conservation; Hotspots, endangered
          organisms. extinction; Red Data Book. biosphere reserves, National
          parks and sanctuaries, Sacred Groves.
        </p>
        <h3>PHYSICS</h3>
        <p>
          <strong>UNIT 1: PHYSICS AND MEASUREMENT:</strong>
          <br />• Units of measurements, System of Units, SI Units, fundamental
          and derived units, least count, significant figures, Errors in
          measurements, Dimensions of Physics quantities, dimensional analysis,
        ...
        <p>
          ...
          subtraction, scalar and vector products, Unit Vector, Resolution of a
          Vector. Relative Velocity, Motion in a plane, Projectile Motion,
        ...
        <p>
          ...
          force; torque, angular momentum, conservation of angular momentum and
          its applications; The moment of inertia, the radius of gyration,
          values of moments of inertia for simple geometrical objects, parallel
          and perpendicular axes theorems, and their applications. Equilibrium
          of rigid bodies, rigid body rotation and equations of rotational
          motion, comparison of linear and rotational motions.
        </p>
        <p>
          <strong>UNIT 6: GRAVITATION:</strong>
          <br />• The universal law of gravitation. Acceleration due to gravity
          and its variation with altitude and depth. Kepler’s law of planetary
          motion. Gravitational potential energy; gravitational potential.
          Escape velocity, Motion of a satellite, orbital velocity, time period,
          and energy of satellite.
        </p>
        <p>
        ...
        <p>
          ...
          <br />• Thermal equilibrium, zeroth law of thermodynamics, the concept
          of temperature. Heat, work, and internal energy. The first law of
        ...
        <p>
          ...
          <br />• Equation of state of a perfect gas, work done on compressing a
          gas, Kinetic theory of gases - assumptions, the concept of pressure.
          Kinetic interpretation of temperature: RMS speed of gas molecules:
          Degrees of freedom. Law of equi-partition of energy and applications
        ...
        <p>
          ...
          its time period: Wave motion. Longitudinal and transverse waves, speed
          of the travelling wave. Displacement relation for a progressive wave.
        ...
        <p>
          ...
          <br />• Electric charges: Conservation of charge. Coulomb's law forces
          ...
          dipole in a uniform electric field. <br />• Electric flux. Gauss's law
          and its applications to find field due to infinitely long uniformly
          charged straight wire uniformly charged infinite plane sheet, and
          uniformly charged thin spherical shell. <br />• Electric potential and
          its calculation for a point charge, electric dipole and system of
          charges; potential difference, Equipotential surfaces, Electrical
          potential energy of a system of two point charges and of electric
          dipole in an electrostatic field. Conductors and insulators.
          Dielectrics and electric polarization, capacitors and capacitances,
          the combination of capacitors in series and parallel, and capacitance
          of a parallel plate capacitor with and without dielectric medium
          between the plates. Energy stored in a capacitor.
        </p>
        <p>
          <strong>UNIT 12: CURRENT ELECTRICITY:</strong>
          <br />• Electric current. Drift velocity, mobility, and their relation
          with electric current. Ohm's law. Electrical resistance. V-l
          ...
          resistance. <br />• Internal resistance, potential difference, and emf
          of a cell, a combination of cells in series and parallel. Kirchhoff’s
        ...
        <p>
          ...
          <br />• Biot - Savart law and its application to the current carrying
          circular loop. Ampere's law and its applications to infinitely long
          current carrying straight wire and solenoid. Force on a moving charge
          in uniform magnetic and electric fields. <br />• Force on a
          ...
          ammeter and voltmeter. <br />• Current loop as a magnetic dipole and
        ...
        <p>
          ...
          voltage: reactance and impedance: LCR series circuit, resonance: power
        ...
        <p>
          ...
          lenses in contact. Refraction of light through a prism. Microscope and
        ...
        <p>
          ...
          LED. the photodiode, solar cell, and Zener diode; Zener diode as a
        ...
        <p>
          ...
          external diameter and depth of a vessel. <br /> 2. Screw gauge-its use
          to determine the thickness/ diameter of thin sheet/wire. <br />
          3. Simple Pendulum-dissipation of energy by plotting a graph between
          the square of amplitude and time. <br /> 4. Metre Scale - the mass of
          a given object by the principle of moments. <br /> 5. Young's modulus
          of elasticity of the material of a metallic wire. <br /> 6. Surf ace
          tension of water by capillary rise and effect of detergents, <br />
          ...
          Specific heat capacity of a given (i) solid and (ii) liquid by method
          of mixtures. <br /> 10. The resistivity of the material of a given
          wire using a metre bridge. <br /> 11. The resistance of a given wire
          using Ohm's law. <br /> 12. Resistance and figure of merit of a
          galvanometer by half deflection method. <br /> 13. The focal length
          of; (i) Convex mirror (ii) Concave mirror, and (ii) Convex lens, using
          the parallax method. <br /> 14. The plot of the angle of deviation vs
          angle of incidence for a triangular prism. <br /> 15. The refractive
          index of a glass slab using a travelling microscope. <br /> 16.
          Characteristic curves of a p-n junction diode in forward and reverse
          bias. <br /> 17. Characteristic curves of a Zener diode and finding
          reverse breakdown voltage. <br /> 18. Identification of Diode. LED,
        ...
        <p>
          ...
          atom, molecule, element, and compound:: Laws of chemical combination;
        ...
        <p>
          ...
          postulates, derivation of the relations for the energy of the electron
          and radii of the different orbits, limitations of Bohr's model; Dual
          nature of matter, de Broglie's relationship. Heisenberg uncertainty
          principle. Elementary ideas of quantum mechanics, quantum mechanics,
          the quantum mechanical model of the atom, and its important features.
          Concept of atomic orbitals as one-electron wave functions: Variation
          of  and 2 with r for 1s and 2s orbitals; various quantum numbers
          (principal, angular momentum, and magnetic quantum numbers) and their
          significance; shapes of s, p, and d - orbitals, electron spin, and
          spin quantum number: Rules for filling electrons in orbitals – Aufbau
          principle. Pauli's exclusion principle and Hund's rule, electronic
          configuration of elements, and extra stability of half-filled and
          completely filled orbitals.
        </p>
        <p>
          <strong>UNIT 3: CHEMICAL BONDING AND MOLECULAR STRUCTURE :</strong>
          <br />• Kossel-Lewis approach to chemical bond formation, the concept
          of ionic and covalent bonds. <br />• Ionic Bonding: Formation of ionic
          bonds, factors affecting the formation of ionic bonds; calculation of
          lattice enthalpy. <br />• Covalent Bonding: Concept of
          electronegativity. Fajan’s rule, dipole moment: Valence Shell Electron
          Pair Repulsion (VSEPR ) theory and shapes of simple molecules. <br />•
          Quantum mechanical approach to covalent bonding: Valence bond theory -
          its important features, the concept of hybridization involving s, p,
          and d orbitals; Resonance. <br />• Molecular Orbital Theory - Its
          important features. LCAOs, types of molecular orbitals (bonding,
          antibonding), sigma and pi-bonds, molecular orbital electronic
          configurations of homonuclear diatomic molecules, the concept of bond
          order, bond length, and bond energy. <br />• Elementary idea of
        ...
        <p>
          ...
          extensive and intensive properties, state functions, Entropy, types of
          processes. <br />• The first law of thermodynamics - Concept of work,
          heat internal energy and enthalpy, heat capacity, molar heat capacity;
          ...
          transition, hydration, ionization, and solution. <br />• The second
          law of thermodynamics - Spontaneity of processes; △S of the universe
          and G of the system as criteria for spontaneity. △G° (Standard Gibbs
          energy change) and equilibrium constant.
        </p>
        <p>
          <strong>UNIT 5: SOLUTIONS:</strong>
          <br />• Different methods for expressing the concentration of solution
          ...
          and non-ideal solutions; Colligative properties of dilute solutions -
          a relative lowering of vapour pressure, depression of freezing point,
          the elevation of boiling point and osmotic pressure; Determination of
        ...
        <p>
          ...
          <br />• Meaning of equilibrium is the concept of dynamic equilibrium.
          ...
          the significance of △G and △G° in chemical equilibrium, factors
          affecting equilibrium concentration, pressure, temperature, the effect
          of catalyst; Le Chatelier’s principle. <br />• Ionic equilibrium: Weak
          and strong electrolytes, ionization of electrolytes, various concepts
          of acids and bases (Arrhenius. Bronsted - Lowry and Lewis) and their
          ...
          effect, hydrolysis of salts and pH of their solutions, the solubility
          of sparingly soluble salts and solubility products, and buffer
          solutions.
        </p>
        <p>
          <strong>UNIT 7: REDOX REACTIONS AND ELECTROCHEMISTRY:</strong>
          <br />• Electronic concepts of oxidation and reduction, redox
          reactions, oxidation number, rules for assigning oxidation number, and
          balancing of redox reactions. <br />
        ...
        <p>
          ...
          first-order 11 reactions, their characteristics and half-lives, the
          effect of temperature on the rate of reactions, Arrhenius theory,
          activation energy and its calculation, collision theory of bimolecular
          gaseous reactions (no derivation).
        </p>

        <p>
          <strong>
            UNIT 9: CLASSIFICATION OF ELEMENTS AND PERIODICITY IN PROPERTIES S:
          </strong>
          <br />• Modem periodic law and present form of the periodic table, s,
          p. d and f block elements, periodic trends in properties of elements
        ...
        <p>
          ...
          enthalpy, oxidation states, atomic radii, colour, catalytic behaviour,
          magnetic properties, complex formation, interstitial compounds, alloy
          formation; Preparation, properties, and uses of K2Cr2O7, and KMnO4.
        ...
        <p>
          ...
          hydrogen, nitrogen, halogens, sulphur, and phosphorus. Calculations of
          empirical formulae and molecular formulae: Numerical problems in
          organic quantitative analysis,
        </p>
        <p>
          <strong>UNIT 14:SOME BASIC PRINCIPLES OF ORGANIC CHEMISTRY :</strong>
          <br />• Tetravalency of carbon: Shapes of simple molecules -
          hybridization (s and p): Classification of organic compounds based on
          functional groups: and those containing halogens, oxygen, nitrogen,
          and sulphur; Homologous series: Isomerism - structural and
          stereoisomerism. <br />
        ...
        <p>
          ...
          Mechanism of halogenation of alkanes. <br />
          ...
          and peroxide effect): Ozonolysis and polymerization. <br />
        ...
        <p>
          ...
          to {">"}C=O group, relative reactivities of aldehydes and ketones;
          Important reactions such as - Nucleophilic addition reactions
          (addition of HCN. NH3, and its derivatives), Grignard reagent;
          oxidation: reduction (Wolf Kishner and Clemmensen); the acidity of
          -hydrogen. aldol condensation, Cannizzaro reaction. Haloform
        ...
        <p>
          ...
          (glucose and fructose) and constituent monosaccharides of
          oligosaccharides (sucrose, lactose, and maltose). <br />
        ...
        <p>
          ...
          KMnO4 <br />• Chemical principles involved in the qualitative salt
          analysis: <br />
          Cations – Pb2+, Cu2+, Al3+, Fe3+, Zn2+, Ni2+, Ca2+, Ba2+, Mg2+ , NH4 +{" "}
          <br />
          Anions- CO3 2−, S 2- ,SO4 2−, NO3- , NO2- , Cl- , Br- , I- ( Insoluble
          salts excluded). <br />
